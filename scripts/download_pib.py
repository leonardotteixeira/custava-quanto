...
VARS_ANUAL = {
    ...
    # "PIB - valores correntes" e "PIB per capita - valores correntes".
    "pib_nominal": ["pib", "valores", "correntes"],
    "pib_per_capita": ["pib", "capita", "valores", "correntes"],
...
# total, por exemplo).
EXCLUIR = {
    "pib_nominal": ["capita", "deflator", "anterior", "volume"],
    "pib_per_capita": ["deflator", "anterior", "volume"],
    "populacao": [],
...
def baixar_tabela(tabela: str) -> tuple[list[dict] | None, dict]:
    ...
    if tabela == TABELA_TRIMESTRAL:
        # sem escolher o setor, o SIDRA devolve ".." (indisponível) em tudo.
        # c11255/90707 = "PIB a preços de mercado" (conferido na API em 2026-09).
        url += "/c11255/90707"
    try:
